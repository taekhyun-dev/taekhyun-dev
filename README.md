...
**FedSAP** (Satellite-Adapted Federated Learning) — a federated learning framework that treats LEO satellites as clients, with a theoretically derived optimal global learning rate for staleness-aware aggregation. Validated on a 238-satellite Walker-Delta constellation against FedAsync, FedBuff, FedSpace, and FedOrbit.
*Manuscript in preparation — code will be released upon publication.*
